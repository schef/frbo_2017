...
\usepackage[footskip=34pt, hmarginratio=1:1, left=20mm, bottom=24mm]{geometry}
\usepackage{graphicx}
...
\addcontentsline{toc}{section}{\texorpdfstring{{\color{blue}1}\hspace{7.9pt}}{}VREMEPLOV}
\includepdf[pages={1},noautoscale]{na_putu/12_super_tata.pdf}
\end{minipage}
\newpage
...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\color{blue}2}\hspace{7.9pt}}{BUDI JAK I HRABAR}}
\includepdf[pages={1},noautoscale]{na_putu/budi_jak_i_hrabar.pdf}
\end{minipage}
\newpage
...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\color{blue}3}\hspace{7.9pt}}{BAŠ JE FORA ŠTO TE VIDIM}}
\includepdf[pages={1},noautoscale]{na_putu/bas_je_fora.pdf}
\end{minipage}
\newpage
...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\color{blue}4}\hspace{7.9pt}}{JEDNA KAP}}
\includepdf[pages={1},noautoscale]{na_putu/jedna_kap.pdf}
\end{minipage}
\newpage
%slikica
\begin{center}
...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\color{blue}5}\hspace{7.9pt}}{STAT', ČUT' I POSLUŠAT'}}
\includepdf[pages={1},noautoscale]{na_putu/stat_cut_i_poslusat.pdf}
\end{minipage}
...
\includepdf[pages={2},noautoscale, %
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,5){\includegraphics[scale=1]{images/mihovil/b2_ljubav}}}]%
         {na_putu/stat_cut_i_poslusat.pdf}
...
\begin{center}
\vspace{1cm}
\includegraphics[width=1\linewidth]{images/cd}
