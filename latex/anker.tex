...
\includepdf[pages={2},noautoscale, %
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,5){\includegraphics[width=\linewidth,scale=1]{images/susanne/e5_wennichdichnurhabe}}}]%
...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\rednifont\doccolor3.}\hspace{\onedigitspacing}}{}LICHT VERTREIBT DIE DUNCKELHEIT \ttfamily(Jr 29,11)}
...
\begin{center}
	...
	\Large{\parbox{\linewidth}{
		...
		{\Large
		\texttt{
			\textit{"Denn ich weiß wohl, was ich für Gedanken über euch habe, spricht der HERR: Gedanken des Friedens und nicht des Leidens, daß ich euch gebe das Ende, des ihr wartet."}
			}
		}
		\end{center}
		\begin{center}
		{\Large
			\texttt{{\textemdash Jeremia 29,11}}
		}
		\end{center}
	}
}
...
\includepdf[pages={1},noautoscale,  %
    picturecommand={\setlength\unitlength{1cm}%
         \put(2,5){\includegraphics[width=\linewidth,scale=1]{images/susanne/d4_ichundmeinhaus}}}]%
...
\newpage
\begin{center}
\includegraphics[width=0.9\linewidth]{images/susanne/h8_allesaufdenkopfgestellt}
\end{center}
...
\newpage
\begin{center}
\includegraphics[width=0.9\linewidth]{images/susanne/j10_lobtdenherrnmitallerkraft}
\end{center}
...
\newpage
\begin{center}
\includegraphics[width=\linewidth]{images/susanne/k11_freudichsehr}
\end{center}
...
\newpage
\begin{center}
\includegraphics[width=\linewidth]{images/susanne/l12_singtdemherrn}\\
\vspace*{1cm}
\includegraphics[width=\linewidth]{images/susanne/Lichtvertreibtdiedunkelheit}
\end{center}
