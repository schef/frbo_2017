...
\phantomsection
\begin{minipage}[b]{0.5\linewidth}
\addcontentsline{toc}{section}{\texorpdfstring{{\rednifont\doccolor3.}\hspace{\onedigitspacing}}{}LICHT VERTREIBT DIE DUNKELHEIT \ttfamily(Jes 9,1.5; 7,14)}
...
\newpage
\begin{center}
\includegraphics[width=0.98\linewidth]{images/susanne/h8_allesaaufdenkopfgestellt2}
\captionof*{figure}{Bild. Mihovil Dorotić}
\end{center}
...
\includepdf[pages={2},noautoscale, %
    picturecommand={\setlength\unitlength{1cm}%
         \put(5,2.5){\includegraphics[width=0.65\linewidth,scale=1]{images/susanne/k11_freuedichsehr}}}]%
